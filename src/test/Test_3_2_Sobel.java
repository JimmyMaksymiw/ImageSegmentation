...
public class Test_3_2_Sobel {
    public static void main(String[] args) throws IOException {
        ...
        image.saveImage("tests/test3_sobel/test3.2", fileName + "_sobel-" + sobelThres);
        ...
        image.saveImage("tests/test3_sobel/test3.2", fileName + "_sobel-" + sobelThres + "_segmentize_thres-" + segThres);
    }
}
