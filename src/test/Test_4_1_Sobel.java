...
public class Test_4_1_Sobel {
    public static void main(String[] args) throws IOException {
        ...
        image.saveImage("tests/test4_sobel/test4.1", fileName + "_sobel-" + sobelThres);
        ...
        image.saveImage("tests/test4_sobel/test4.1", fileName + "_sobel-" + sobelThres + "_segmentize_thres-" + segThres);
    }
}
